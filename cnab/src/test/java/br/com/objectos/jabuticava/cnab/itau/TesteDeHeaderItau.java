 ...
 * the License.
 */
package br.com.objectos.jabuticava.cnab.itau;

import static br.com.objectos.jabuticava.cnab.Itau.header;
...
import br.com.objectos.jabuticava.cnab.CnabsFalso;
import br.com.objectos.jabuticava.cnab.Header;
...
public class TesteDeHeaderItau {
  ...
  public void data_de_gravacao_do_arquivo() {
    assertThat(header.get(header().dataDeGeracaoDoArquivo()), equalTo(LocalDate.of(2012, 8, 1)));
  }
  ...
  public void data_de_credito() {
    assertThat(header.get(header().dataDeCredito()), equalTo(LocalDate.of(2012, 8, 2)));
  }
