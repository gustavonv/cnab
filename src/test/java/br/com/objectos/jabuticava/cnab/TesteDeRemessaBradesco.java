...
import br.com.objectos.jabuticava.cnab.remessa.AgenciasFalso;
...
import br.com.objectos.jabuticava.cnab.remessa.ConstrutorDeCobrancaFalso;
...
import br.com.objectos.jabuticava.cnab.remessa.ContasFalso;
...
import br.com.objectos.jabuticava.cnab.remessa.SacadosFalso;
...
public class TesteDeRemessaBradesco {
  ...
  public void integracao() throws IOException {
    Titulo t0 = novoTitulo()
        ...
        .emissao(new LocalDate(2012, 10, 4))
        .vencimento(new LocalDate(2012, 11, 10))
        .valor(1234.56)
        .novaInstancia();
    ...
    Titulo t1 = novoTitulo()
        ...
        .emissao(new LocalDate(2012, 8, 24))
        .vencimento(new LocalDate(2012, 11, 15))
        .valor(505d)
        .novaInstancia();
