...
import static br.com.objectos.cnab.remessa.Caixa.ALTA;
import static br.com.objectos.cnab.remessa.EnderecamentoDebitoAutomatico.CADASTRO_CONSTANTE;
...
class BradescoLoteRemessaSpec
  ...
  private final CnabKey<BradescoLoteRemessa, br.com.objectos.cnab.remessa.Comando> idDaOcorrencia;
  ...
  @Override
  public CnabKey<BradescoLoteRemessa, br.com.objectos.cnab.remessa.Comando> comando() {
